...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=kali,linux,html,css,js,python,bash,obsidian,notion,debian,ubuntu,arch,vscode,docker,github,latex,neovim,react,powershell,materialui,nginx,mongodb,mysql,nextjs,nodejs,postman,py,react,redux,tailwind,ts,vscode,kubernetes,linux,js&perline=14" />
  </a>
</p>
